...
>
> 這一包要做的是 **給它鑰匙**：裝兩把鑰匙、各用一次，然後把用過的那一次寫成流程。大概 90 分鐘（含裝 Obsidian），你要動手的只有三件事——點頭讓我改設定、重開兩次對話、回答幾題選擇題。
>
...
這一包的題目按這個順序問，**每題都在它該出現的地方問，不要一次問完**：

**A-1｜在 B-2 動手之前**
> 我要幫你裝第一把鑰匙。它會改到你家目錄底下的一個設定檔，可以嗎？
1. 可以，裝吧（推薦）——我直接跑指令，改完把改了什麼秀給你看
2. 先跟我說它會碰到什麼——我解釋完再問你一次
3. 其他（我自己說）
...
> 選 1 的時候：**你自己挑一支公開、無版權疑慮的短片**（官方頻道的產品說明、公開演講這類），把網址講給他聽再跑，不要偷偷跑一支他不知道是什麼的東西。
